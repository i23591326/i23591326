 ...
 */
class DemoTableDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_0__["DataSource"] {
    constructor() {
        super();
...
let DemoTableComponent = class DemoTableComponent {
    constructor() {
...
let DragDropNavigationComponent = class DragDropNavigationComponent extends _drag_drop_component__WEBPACK_IMPORTED_MODULE_6__["DragDropComponent"] {
    constructor() {
        super(...arguments);
    ...
    updateActiveItem(index, keyManager) {
        if (index > 0) {
...
let LocalDropdownOriginComponent = class LocalDropdownOriginComponent extends primeng_iow_infinite_dropdown_dropdown_origin_dropdown_origin_component__WEBPACK_IMPORTED_MODULE_2__["DropdownOriginComponent"] {
};
...
let LazyDropdownComponent = class LazyDropdownComponent extends primeng_iow_infinite_dropdown__WEBPACK_IMPORTED_MODULE_2__["InfiniteDropdownComponent"] {
    constructor() {
        super(...arguments);
        this.dataSource = new _lazy_scroll_data_source__WEBPACK_IMPORTED_MODULE_3__["LazyDataSource"]();
        this.KeyManager = _angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_4__["ActiveDescendantKeyManager"];
        this.lazyOptionsListConfig = { maxHeight: 400 };
        this.getLabel = option => option;
    }
};
...
let LazyDropdownModule = class LazyDropdownModule {
};
...
class LazyDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_0__["DataSource"] {
    constructor() {
        super(...arguments);
        ...
        this._dataStream = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](this._cachedData);
...
let OptionsVirtualScrollManagerDirective = class OptionsVirtualScrollManagerDirective extends primeng_iow_cdk_scrolling__WEBPACK_IMPORTED_MODULE_2__["OptionsScrollManagerComponent"] {
    constructor(scrollable) {
        super();
        this.scrollable = scrollable;
    }
    scrollToOption(item) {
        const { start } = this.scrollable.getRenderedRange();
        const index = this.options.toArray().indexOf(item) + start;
        this.scrollToIndex(index);
    }
};
OptionsVirtualScrollManagerDirective.ctorParameters = () => [
...
let OptionsGroupListComponent = class OptionsGroupListComponent {
    constructor() {
...
let ActivityManagerUpgradedComponent = ActivityManagerUpgradedComponent_1 = class ActivityManagerUpgradedComponent extends primeng_iow_cdk_options_activity_manager__WEBPACK_IMPORTED_MODULE_2__["OptionsActivityManagerComponent"] {
    ngAfterContentInit() {
...
ActivityManagerUpgradedComponent = ActivityManagerUpgradedComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [{
                ...
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => ActivityManagerUpgradedComponent_1),
            }]
    })
...
let ActivityManagerUpgradedDirective = ActivityManagerUpgradedDirective_1 = class ActivityManagerUpgradedDirective extends primeng_iow_cdk_options_activity_manager__WEBPACK_IMPORTED_MODULE_2__["OptionsActivityManagerComponent"] {
    constructor() {
        super(...arguments);
        this.keydown$ = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
    }
    select($event) {
    ...
    ngAfterContentInit() {
        ...
        if (this.config.withTypeAhead) {
            const withTypeAheadConfig = this.config.withTypeAhead;
            const debounce = Object(_is_with_type_ahead_config_guard__WEBPACK_IMPORTED_MODULE_3__["isWithTypeAheadConfig"])(withTypeAheadConfig) ? withTypeAheadConfig.debounceInterval : 300;
...
ActivityManagerUpgradedDirective = ActivityManagerUpgradedDirective_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
        ...
        providers: [{
                provide: primeng_iow_cdk_options_activity_manager__WEBPACK_IMPORTED_MODULE_2__["OptionsActivityManagerComponent"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => ActivityManagerUpgradedDirective_1),
            }],
...
let FocusableOptionComponent = FocusableOptionComponent_1 = class FocusableOptionComponent extends primeng_iow_cdk_options__WEBPACK_IMPORTED_MODULE_2__["BaseOption"] {
    constructor(cd, selectionManager) {
        super();
        this.cd = cd;
...
FocusableOptionComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
...
let HighlightableContentOptionUpgradedComponent = HighlightableContentOptionUpgradedComponent_1 = class HighlightableContentOptionUpgradedComponent extends primeng_iow_cdk_options__WEBPACK_IMPORTED_MODULE_2__["HighlightableContentOption"] {
    constructor() {
        super(...arguments);
        this.getLabel = () => this.labelGetter(this.value);
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let FlatTreeComponent = class FlatTreeComponent {
    ...
    get activeNode() {
        const activeOption = this.activityManager.keyManager.activeItem;
    ...
    onArrowLeft() {
        if (this.activeNode && this.treeControl.isExpandable(this.activeNode) && this.treeControl.isExpanded(this.activeNode)) {
            ...
            const parentOption = this.options.find(option => option.value === this.getParentNode(this.activeNode));
...
let NestedTreeComponent = class NestedTreeComponent {
    constructor() {
